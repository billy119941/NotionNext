 ...
 * });
 * 
 * const isValid = validator.isValidURL('https://example.com/post');
 * const cleanUrl = validator.cleanURL('/post?query=1#fragment');
 */
...
export class URLValidator {
  ...
  generateURL(slug, locale = '') {
    ...
    // 处理slug前缀
    const cleanSlug = (typeof slug === 'string' && slug.startsWith('/')) ? slug.slice(1) : slug
